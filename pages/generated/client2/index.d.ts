  ...
  */
  ...
  export interface trdDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find zero or more Trds that matches the filter.
     * @param {trdFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const trd = await prisma.trd.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
    ...
    /**
     * Perform aggregation operations on a Trd.
     * @param {trdAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const trd = await prisma.trd.aggregateRaw({
     *   pipeline: [
   ...
   * trd aggregateRaw
   */
  export type trdAggregateRawArgs = {
    /**
  ...
  export type trdWhereInput = {
    ...
    TRD_TOTAL_VALUE?: FloatFilter | number
  ...
  export type trdScalarWhereWithAggregatesInput = {
    ...
    TRD_TOTAL_VALUE?: FloatWithAggregatesFilter | number
  ...
  export type trdUpdateInput = {
    ...
    TRD_TOTAL_VALUE?: FloatFieldUpdateOperationsInput | number
